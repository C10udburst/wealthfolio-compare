...
All notable changes to the wealthfolio-compare addon will be documented in this file.
...
### Added
- Initial release of wealthfolio-compare addon
...
### Features
- A wealthfolio addon that allows you to compare your wealth to different metrics
